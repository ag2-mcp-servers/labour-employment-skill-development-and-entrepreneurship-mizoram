...
#   timestamp: 2025-06-28T15:13:01+00:00
...
class CertificateParameters(BaseModel):
    ...
    REGNO: str = Field(..., description='Registration No', examples=['FMZ01198000001'])
...
class GovidCertificatePostRequest(BaseModel):
...
class GovidCertificatePostResponse(BaseModel):
...
class GovidCertificatePostResponse1(BaseModel):
...
class GovidCertificatePostResponse2(BaseModel):
...
class GovidCertificatePostResponse3(BaseModel):
...
class GovidCertificatePostResponse4(BaseModel):
...
class GovidCertificatePostResponse5(BaseModel):
...
class GovidCertificatePostResponse6(BaseModel):
